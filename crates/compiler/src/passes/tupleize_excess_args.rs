    ...
    match s {
        Statement::Assign(assign_dest, expr, _) => {
            match assign_dest {
                ...
                | AssignDest::SubscriptForInit(id, _idx, _) => {
            ...
            ast: Program {
                functions: vec![Function {
                    ...
                    params: IndexMap::from_iter([
                        (t_global!("a1"), ValueType::IntType),
                        (t_global!("a2"), ValueType::IntType),
                        (t_global!("a3"), ValueType::IntType),
                        (t_global!("a4"), ValueType::IntType),
                    ]),
                    body: vec![
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a1")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a2")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a3")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a4")))),
                    ],
                    types: TypeEnv::new(),
            ...
            ast: Program {
                functions: vec![Function {
                    ...
                    params: IndexMap::from_iter([
                        ...
                        (t_global!("a3"), ValueType::IntType),
                        (t_global!("a4"), ValueType::IntType),
                        (t_global!("a5"), ValueType::IntType),
                        (t_global!("a6"), ValueType::IntType),
                        (t_global!("a7"), ValueType::IntType),
                    ]),
                    body: vec![
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a1")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a2")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a3")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a4")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a5")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a6")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a7")))),
                    ],
                    types: TypeEnv::new(),
                    return_type: ValueType::NoneType,
                }],
            ...
            ast: Program {
                functions: vec![Function {
                    ...
                    params: IndexMap::from_iter([
                        ...
                        (t_global!("a6"), ValueType::IntType),
                        (t_global!("a7"), ValueType::IntType),
                        (t_global!("a8"), ValueType::IntType),
                        (t_global!("a9"), ValueType::IntType),
                        (t_global!("a10"), ValueType::IntType),
                        (t_global!("a11"), ValueType::IntType),
                        (t_global!("a12"), ValueType::IntType),
                        (t_global!("a13"), ValueType::IntType),
                        (t_global!("a14"), ValueType::IntType),
                        (t_global!("a15"), ValueType::IntType),
                        (t_global!("a16"), ValueType::IntType),
                        (t_global!("a17"), ValueType::IntType),
                    ]),
                    body: vec![
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a1")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a2")))),
                        ...
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a6")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a7")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a8")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a9")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a10")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a11")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a12")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a13")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a14")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a15")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a16")))),
                        Statement::Expr(ast_print_int(Expr::Id(t_global!("a17")))),
                    ],
                    types: TypeEnv::new(),
                    return_type: ValueType::NoneType,
                }],
                ...
                functions: vec![
                    ...
                    Function {
                        ...
                        body: vec![Statement::Expr(Expr::Call(
                            Box::new(Expr::GlobalSymbol(t_global!("a"))),
