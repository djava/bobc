            ...
            (IntType, IntType) => {
                    ...
                    && let Value::I64(r_val) = r
                {
                    match self {
                        ...
                        BinaryOperator::LeftShift => Value::I64(l_val << r_val),
                        BinaryOperator::RightShift => Value::I64(l_val >> r_val),
                        BinaryOperator::Divide => Value::I64(l_val / r_val),
                        BinaryOperator::Modulo => Value::I64(l_val % r_val),
...
mod tests {
    ...
    fn test_multiply_mixed_with_add_fold() {
        ...
        execute_test_case(TestCase {
            ...
            inputs: VecDeque::new(),
            expected_outputs: VecDeque::from(vec![Value::I64(26)]),
        })
    }
    ...
    fn test_while_loop_constant_false() {
        ...
        execute_test_case(TestCase {
            ...
            inputs: VecDeque::new(),
            expected_outputs: VecDeque::from(vec![Value::I64(42)]), // Loop should be removed entirely
        });
    }
    ...
    fn test_while_loop_with_partial_eval_in_body() {
        ...
        execute_test_case(TestCase {
            ...
            inputs: VecDeque::new(),
            expected_outputs: VecDeque::from(vec![Value::I64(20), Value::I64(20), Value::I64(20)]),
        });
    }
}
