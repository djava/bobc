    ...
    pub fn make_opt() -> Self {
        Self {
            ast_passes: vec![
                ...
                ASTtoAST::from(TypeCheck),
                ASTtoAST::from(DisambiguateSubscript),
                ASTtoAST::from(ExtractStringOps),
                ASTtoAST::from(ConstantFolding),
                ...
                ASTtoAST::from(DeclosurizeCalls),
            ],
